...
describe('chatBot routes module', () => {
  ...
  describe('GET /games', () => {
    test('200 - OK', (done) => {
      ...
      req.get('/games').expect(200, 'Games response', done);
    });
  ...
  describe('GET /song', () => {
    ...
    test('200 - OK', (done) => {
      ...
      req.get('/song?user=someUser').expect(200, 'Song response', done);
    });
    ...
    test('500 - Error', (done) => {
      ...
      req.get('/song?user=someUser').expect(500, done);
    });
  });
  ...
  describe('GET /time', () => {
    test('200 - OK', (done) => {
      ...
      req.get('/time').expect(200, 'Time response', done);
    });
  ...
  describe('GET /uptime', () => {
    test('200 - OK', (done) => {
      ...
      req.get('/uptime').expect(200, 'Uptime response', done);
    });
    ...
    test('500 - Error', (done) => {
      ...
      req.get('/uptime').expect(500, done);
    });
  });
  ...
  describe('GET /whatnow', () => {
    ...
    test('500 - Error', (done) => {
      ...
      req.get('/whatnow').expect(500, done);
    });
  });
});
